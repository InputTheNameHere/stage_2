...
plt.savefig("results/plots/1_indexing_throughput.png", dpi=160)
...
plt.legend()
plt.grid(True, alpha=0.3)
plt.savefig("results/plots/2_query_latency.png", dpi=160)
...
plt.ylabel("CPU (%)")
plt.grid(True, alpha=0.3)
plt.savefig("results/plots/3_cpu_usage.png", dpi=160)
...
plt.grid(True, alpha=0.3)
plt.savefig("results/plots/4_memory_usage.png", dpi=160)
